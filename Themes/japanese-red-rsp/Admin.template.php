...
function template_admin()
{
	...
	if ($context['user']['is_admin'])
		echo '
				...
				<form action="', $scripturl, '?action=admin;area=search" method="post" accept-charset="', $context['character_set'], '" class="quicksearch">
...
function template_view_versions()
{
	...
	echo '
			...
			<table id="Sources" style="width:100%" class="table_grid">
			<tbody>';
	...
	foreach ($context['file_versions'] as $filename => $version)
		echo '
				<tr>
					<td class="windowbg2" style="width:50%" style="padding-left: 3ex;">
						', $filename, '
					</td>
	...
	echo '
			...
			<table id="Default" style="width:100%" class="table_grid">
				<tbody>';
	...
	echo '
			...
			<table id="Languages" style="width:100%" class="table_grid">
				<tbody>';
	...
	if (!empty($context['template_versions']))
	{
		echo '
			...
			<table id="Templates" style="width:100%" class="table_grid">
				<tbody>';
...
function template_edit_censored()
{
	...
	echo '
					...
					// ]]></script>
					<hr style="width:100%" size="1" class="hrcolor clear" />
					<dl class="settings">
						<dt>
			...
			<table class="table_grid" cellspacing="0" style="width:100%">
				<thead>
					<tr class="catbg">
						...
						<th class="last_th" scope="col" style="width:50">
