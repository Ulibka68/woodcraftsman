...
function template_showPosts()
{
	...
	{
		echo '
		<table border="0" style="width:100%" cellspacing="1" cellpadding="2" class="table_grid" align="center">
			<thead>
				<tr class="titlebg">
...
function template_editBuddies()
{
	...
	echo '
		...
		<table border="0" style="width:100%" cellspacing="1" cellpadding="4" class="table_grid" align="center">
			<tr class="catbg">
...
function template_showPermissions()
{
	...
	else
	{
		...
		{
			echo '
					<table class="table_grid" style="width:100%" cellspacing="0">
						<thead>
							<tr class="titlebg">
...
function template_groupMembership()
{
	...
	{
		echo '
			<table border="0" style="width:100%" cellspacing="0" cellpadding="4" class="table_grid">
				<thead>
					<tr class="catbg">
...
function template_issueWarning()
{
	...
	echo '<br />
		...
		<table border="0" style="width:100%" cellspacing="0" cellpadding="5" class="table_grid">
			<thead>
	...
	foreach ($context['previous_warnings'] as $warning)
	{
		...
		if (!empty($warning['id_notice']))
			echo '
						<div class="floatright">
							<a href="', $scripturl, '?action=moderate;area=notice;nid=', $warning['id_notice'], '" onclick="window.open(this.href, \'\', \'scrollbars=yes,resizable=yes,style="width:400,height=250\');return false;" target="_blank" class="new_win" title="', $txt['profile_warning_previous_notice'], '"><img src="', $settings['images_url'], '/filter.gif" alt="" /></a>
						</div>';
		echo '
					</td>
...
function template_profile_avatar_select()
{
	...
	if (!empty($context['member']['avatar']['allow_server_stored']))
	{
		...
		echo '
									...
									<div>
										<select name="file" id="file" size="10" style="display: none;" onchange="showAvatar()" onfocus="selectRadioByName(document.forms.creator.avatar_choice, \'server_stored\');" disabled="disabled"></select>
									</div>
	...
	if (!empty($context['member']['avatar']['allow_upload']))
	{
		echo '
								<div id="avatar_upload">
									<input type="file" size="44" name="attachment" onfocus="selectRadioByName(document.forms.creator.avatar_choice, \'upload\');" class="input_file" />
