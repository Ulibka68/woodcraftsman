...
$txt['welcome_guest'] = 'Welcome, <strong>%1$s</strong>. Please <a style="color: #ff896e;" href="' . $scripturl . '?action=login">login</a> or <a style="color: #ff896e;" href="' . $scripturl . '?action=register">register</a>.';
...
$txt['unread_since_visit'] = 'Show unread posts.';
$txt['show_unread_replies'] = 'Show new replies.';
...
$txt['instagram_no_post_id'] = 'No Instagram post ID supplied.';
$txt['instagram_default_width'] = 'Default width used for Instagram bbcode when not specified<div class="smalltext">Use <strong>0</strong> to use responsive video display</div>';
$txt['instagram_default_height'] = 'Default height used for Instagram bbcode when not specified<div class="smalltext">Use <strong>0</strong> to use responsive video display</div>';
$txt['instagram_include_link'] = 'Include Instagram link below post?';
