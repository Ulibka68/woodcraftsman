...
function template_search_results()
{
	...
	<thead>
		<tr class="catbg">
			<th class="lefttext first_th">', $txt['date'], '</th>
			<th class="lefttext">', $txt['subject'], '</th>
			<th class="lefttext last_th">', $txt['from'], '</th>
		</tr>
	</thead>
	<tbody>';
	...
	foreach ($context['personal_messages'] as $message)
	{
		...
		if (!empty($context['search_params']['show_complete']))
		{
			...
			<div class="windowbg', $alternate ? '2': '', '">
				...
				if ($context['can_send_pm'])
				{
					$quote_button = create_button('quote.gif', 'reply_quote', 'reply_quote', 'style="vertical-align:middle;"');
					$reply_button = create_button('im_reply.gif', 'reply', 'reply', 'style="vertical-align:middle;"');
...
function template_report_message()
{
	...
	echo '
					...
					<dd>
						<textarea name="reason" rows="4" cols="70" style="' . ($context['browser']['is_ie8'] ? 'width: 635px; width: 80%; min-width: 80%' : 'width: 80%') . ';"></textarea>
					</dd>
				</dl>
				<div class="righttext">
