...
if ( smf_mobile_detect === 'mobile' ) {
    photobtn.setAttribute('width', 40);
    photobtn.setAttribute('height', 40);
    photobtn.setAttribute('src', smf_images_url + '/bbc/ar-camera.png');
}
...
function InsertContent(html) {
    ...
    document.getElementById('btnFrmGcs5_cancel').addEventListener('click',
        function () { document.getElementById("popup-container-background").style.display='none';}
    );
