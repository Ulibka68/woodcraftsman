		...
		if ($row_board['id_parent'] == $boardIndexOptions['parent_id'])
		{
			...
			if (!isset($this_category[$row_board['id_board']]))
			{
				...
				$this_category[$row_board['id_board']] = array(
					...
					'redirect_img' => $row_board['img_redirect'] !== '' ? BoardIconUrl($row_board['img_redirect_type'], $row_board['img_redirect']) : '',
...
function BoardIconUrl($type = 0, $url = '')
{
	...
	// Fix the URL if there are issues with it... (remove http:// at the beginning ofcourse)
