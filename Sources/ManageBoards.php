...
function EditBoard2()
{
	...
	if (isset($_POST['edit']) || isset($_POST['add']))
	{
		...
		*/
		...
		// No need for http://
		if (substr(strtolower($_POST['new_img']), 0, 7) == 'http://')
			$_POST['new_img'] = substr($_POST['new_img'], 7);

		if (substr(strtolower($_POST['no_new_img']), 0, 7) == 'http://')
			$_POST['no_new_img'] = substr($_POST['no_new_img'], 7);

		if (substr(strtolower($_POST['redirect_img']), 0, 7) == 'http://')
